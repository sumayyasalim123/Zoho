# Generated by Django 5.0 on 2024-01-15 18:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('a_ddress', models.CharField(max_length=255)),
                ('contactnumber', models.CharField(max_length=255)),
                ('experience', models.CharField(default=1, max_length=25)),
                ('dob', models.DateField()),
                ('new_dept', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('categories', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sampleapp.categories')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
